...
X.to_csv("clean_X_train.csv", index=False)
y.to_csv("clean_y_train.csv", index=False)
test.to_csv("clean_X_test.csv", index=False)
...
train.to_csv("clean_mean_train.csv", index=False)
test.to_csv("clean_mean_test.csv", index=False)
